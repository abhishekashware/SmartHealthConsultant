...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    private List<Message1> mMessage1List;
    private FirebaseAuth mAuth;
    private Context context;

    public MessageAdapter(Context context,List<Message1> mMessage1List) {
        this.context = context;
        this.mMessage1List = mMessage1List;
    }
    ...
    public void onBindViewHolder(MessageViewHolder holder, int position) {
        ...
        Message1 msg = mMessage1List.get(position);
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setB(){
          ...
          //  mProfileImage.setVisibility(View.VISIBLE);
            RelativeLayout layout=itemView.findViewById(R.id.rela);
            RelativeLayout.LayoutParams params=(RelativeLayout.LayoutParams) mTextMessage.getLayoutParams();
            RelativeLayout.LayoutParams paramsI=(RelativeLayout.LayoutParams) mProfileImage.getLayoutParams();

            params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT,0);
            paramsI.addRule(RelativeLayout.ALIGN_PARENT_LEFT,0);
        }
