...
import com.example.smarthealthconsultant.smarthealthconsultant.Doctor.Prescription;
...
public class DoctorChatActivity extends AppCompatActivity implements IPickResult{
    ...
    //    Toast.makeText(getApplicationContext(),senderId,Toast.LENGTH_SHORT).show();
        ...
        DatabaseReference userInfo = FirebaseDatabase.getInstance().getReference().child("Patient");
  ...
  //                  Log.d(TAG, "onAuthStateChanged:signed_out");
    ...
    public void sendMessage(){
        ...
        if(!TextUtils.isEmpty(message)){
            ...
            String current_user_ref = "Messages/"+doctorId+"/"+senderId;
            String doctor_ref = "Messages/"+senderId+"/"+doctorId;
    ...
    public void loadMessage(){
        ...
        DatabaseReference retriveMessae = FirebaseDatabase.getInstance().getReference().child("Messages").child(dId).child(senderId);
...
//        mUserRef.child("online").setValue(false);
    ...
    public void onPickResult(PickResult pickResult) {
        if (pickResult.getError() == null) {
            ...
            final String current_user_ref = "Messages/"+doctorId+"/"+senderId;
            final String doctor_ref = "Messages/"+senderId+"/"+doctorId;
...
//            }
            mAuth.signOut();
            startActivity(new Intent(DoctorChatActivity.this, LoginPage.class));
            finish();
            return true;
        }
