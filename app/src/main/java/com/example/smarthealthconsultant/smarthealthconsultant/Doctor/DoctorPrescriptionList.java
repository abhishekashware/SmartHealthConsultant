...
import com.example.smarthealthconsultant.smarthealthconsultant.Prescription.PrescriptionListAdapter;
import com.example.smarthealthconsultant.smarthealthconsultant.Prescription.PrescriptionSample;
...
public class DoctorPrescriptionList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Doctor's suggestion");
        ...
        //mUserRef = FirebaseDatabase.getInstance().getReference().child("Patient").child(uId);
...
//            }
            mAuth.signOut();
            startActivity(new Intent(DoctorPrescriptionList.this, LoginActivity.class));
            finish();
            return true;
        }
